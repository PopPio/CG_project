    ...
    private void LoadOBJModel(String ModelPath) {
        try {
            ...
            if (ModelPath.endsWith(".zip")) {
               ...
               System.out.println("MESH IS COMPRESSED! TRY TO EXTRACT FIRST/SINGLE ENTRY!");
                ...
                br = new BufferedReader(new InputStreamReader(Main.class.getResourceAsStream(ModelPath)));
            }
            String line = null;
