...
public class WavefrontObjectLoader_VertexBufferObject {
    ...
    public WavefrontObjectLoader_VertexBufferObject(String inModelPath) {
        ...
        System.out.println("LOADING WAVEFRONT OBJECT MODEL AS VERTEX BUFFER OBJECT "+inModelPath);
    ...
    private void CheckExtensions(GL gl) {
        if (!gl.isExtensionAvailable("GL_ARB_vertex_buffer_object")) {
            ...
            System.out.println("YOUR GRPAHICS CARD DOES NOT SUPPORT THE ARB EXTENSION GL_ARB_vertex_buffer_object ...");
        }
    }
    ...
    private void LoadOBJModel(String inModelPath) {
        try {
            ...
            if (inModelPath.endsWith(".zip")) {
                ...
                System.out.println("WAVEFRONT MESH IS COMPRESSED! TRY TO EXTRACT FIRST/SINGLE ENTRY!");
                ...
                if (inZipEntryName==null) {
                	...
                	System.out.println("ERROR! ZIP ENTRY IS NULL!");
                }
            ...
            System.out.println("MODEL "+inModelPath+" SUCCESSFULLY LOADED!");
        } catch (IOException e) {
